...
<header>
    <nav class="navbar navbar-expand-lg bg-dark navbar-expand-sm">
        <div class="container-fluid">
            <a class="navbar-brand link-light" href="../../index.php"><img src="../../img/Truck_368x368.jpg" width="32px" height="32px"></a>
            ...
            <div class="collapse navbar-collapse link-light" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link link-light active" aria-current="page" href="#">VIEW</a>
                    </li>
                    <li class="nav-item">
